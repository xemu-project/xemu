...
Every AI coding task that touches OpenMidway code must include a complete task declaration (see `.github/AI_TASK_TEMPLATE.md`). Do not begin implementation until all six fields are filled in.
