...
void InputManager::Update()
{
    ...
    if ((current_mouse_pos.x != m_last_mouse_pos.x) ||
        (current_mouse_pos.y != m_last_mouse_pos.y) || ImGui::IsMouseDown(0) ||
...
#define MAP_BUTTON(KEY_NO, BUTTON_NO)                      \
    {                                                      \
        io.AddKeyEvent(KEY_NO, !!(m_buttons & BUTTON_NO)); \
    }
#define MAP_ANALOG(KEY_NO, AXIS_NO, V0, V1)                        \
    ...
    MAP_BUTTON(ImGuiKey_GamepadFaceDown,
               CONTROLLER_BUTTON_A); // Xbox A, PS Cross
    MAP_BUTTON(ImGuiKey_GamepadFaceRight,
               CONTROLLER_BUTTON_B); // Xbox B, PS Circle
    MAP_BUTTON(ImGuiKey_GamepadFaceLeft,
               CONTROLLER_BUTTON_X); // Xbox X, PS Square
    MAP_BUTTON(ImGuiKey_GamepadFaceUp,
               CONTROLLER_BUTTON_Y); // Xbox Y, PS Triangle
    ...
    // MAP_ANALOG(ImGuiKey_GamepadL2, SDL_CONTROLLER_AXIS_TRIGGERLEFT,  0.0f,
    // 32767); MAP_ANALOG(ImGuiKey_GamepadR2, SDL_CONTROLLER_AXIS_TRIGGERRIGHT,
    // 0.0f, 32767); MAP_BUTTON(ImGuiKey_GamepadL3,
    // SDL_CONTROLLER_BUTTON_LEFTSTICK); MAP_BUTTON(ImGuiKey_GamepadR3,
    // SDL_CONTROLLER_BUTTON_RIGHTSTICK);
    MAP_ANALOG(ImGuiKey_GamepadLStickLeft, CONTROLLER_AXIS_LSTICK_X,
               -thumb_dead_zone, -32768);
    MAP_ANALOG(ImGuiKey_GamepadLStickRight, CONTROLLER_AXIS_LSTICK_X,
               +thumb_dead_zone, +32767);
    MAP_ANALOG(ImGuiKey_GamepadLStickUp, CONTROLLER_AXIS_LSTICK_Y,
               +thumb_dead_zone, +32768);
    MAP_ANALOG(ImGuiKey_GamepadLStickDown, CONTROLLER_AXIS_LSTICK_Y,
               -thumb_dead_zone, -32767);
    MAP_ANALOG(ImGuiKey_GamepadRStickLeft, CONTROLLER_AXIS_RSTICK_X,
               -thumb_dead_zone, -32768);
    MAP_ANALOG(ImGuiKey_GamepadRStickRight, CONTROLLER_AXIS_RSTICK_X,
               +thumb_dead_zone, +32767);
    MAP_ANALOG(ImGuiKey_GamepadRStickUp, CONTROLLER_AXIS_RSTICK_Y,
               +thumb_dead_zone, +32768);
    MAP_ANALOG(ImGuiKey_GamepadRStickDown, CONTROLLER_AXIS_RSTICK_Y,
               -thumb_dead_zone, -32767);
#undef MAP_BUTTON
#undef MAP_ANALOG
#undef IM_SATURATE
