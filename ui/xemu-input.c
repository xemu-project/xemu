...
void xemu_input_update_sdl_controller_state(ControllerState *state)
{
    ...
    if (strcmp(bound_driver, DRIVER_STEEL_BATTALION) == 0) {
        ...
        state->sbc.axis[SBC_AXIS_SIGHT_CHANGE_X] = SDL_GetGamepadAxis(
            state->sdl_gamepad, SDL_GAMEPAD_AXIS_LEFTX);
        state->sbc.axis[SBC_AXIS_SIGHT_CHANGE_Y] = SDL_GetGamepadAxis(
            state->sdl_gamepad, SDL_GAMEPAD_AXIS_LEFTY);
        state->sbc.axis[SBC_AXIS_AIMING_X] = SDL_GetGamepadAxis(
            state->sdl_gamepad, SDL_GAMEPAD_AXIS_RIGHTX);
        state->sbc.axis[SBC_AXIS_AIMING_Y] = SDL_GetGamepadAxis(
            state->sdl_gamepad, SDL_GAMEPAD_AXIS_RIGHTY);
        state->sbc.axis[SBC_AXIS_MIDDLE_PEDAL] = SDL_GetGamepadAxis(
            state->sdl_gamepad, SDL_GAMEPAD_AXIS_LEFT_TRIGGER);
        state->sbc.axis[SBC_AXIS_RIGHT_PEDAL] = SDL_GetGamepadAxis(
            state->sdl_gamepad, SDL_GAMEPAD_AXIS_RIGHT_TRIGGER);
